...
import com.dao.InternshipDao;
import com.opensymphony.xwork2.ActionSupport;


public class InternshipAddSave extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		cnbean.setSnoemployer((String)session.getAttribute("id"));
		new InternshipDao().Add(cnbean);
		    
		//跳转
		out.print("<script language='javascript'>alert('添加成功！');window.location='InternshipManager.action';</script>");
		out.flush();out.close();return null;
