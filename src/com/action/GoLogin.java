...
public class GoLogin extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		else if(Type.equals("招聘者"))
		{
			if (null == new EmployerDao().CheckLogin(Username, Password)) {
				Msg = "用户名或者密码错误";
				return INPUT;
			}
			else
		...
		else if(Type.equals("求职者"))
		{
			if (null == new EmployeeDao().CheckLogin(Username, Password)) {
				Msg = "用户名或者密码错误";
				return INPUT;
			}
			else
