...
public class EmployerAddSave extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		cnbean.setSnoemployer(Snoemployer);
		...
		new EmployerDao().Add(cnbean);
		    
		//跳转
		out.print("<script language='javascript'>alert('添加成功！');window.location='EmployerManager.action';</script>");
		out.flush();out.close();return null;
