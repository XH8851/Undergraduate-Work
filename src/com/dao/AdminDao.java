...
public class AdminDao {
	...
	public String CheckLogin(String username, String password){
		String id = null;
		String sql="select * from tb_Admin where admin_name='"+username+"' and admin_password='"+password+"'";
		Statement stat = null;
		ResultSet rs = null;
	...
	public boolean CheckPassword(String id, String password){
		boolean ps = false;
		String sql="select * from tb_Admin where admin_id='"+id+"' and Admin_Password='"+password+"'";
		Statement stat = null;
		ResultSet rs = null;
		Connection conn = new DBHelper().getConn();
		try{
