        ...
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <%if(!session.getAttribute("type").toString().equals("3")){%>
              <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">修改招聘者</td>
             <%}else{%>
              <td height="30" background="Images/mainMenuBg.jpg" style="padding-left:25px;">查看招聘者</td>
              <%}%>
            </tr>
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE">
              <form name="form1" method="post" action="EmployerUpdateSave.action" onSubmit="return mycheck()" >
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td><input name="Snoemployer" type="text" class="text2" id="Snoemployer" disabled="disabled" value="<s:property value='cnbean.Snoemployer'/>"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input name="Jno" type="text" class="text2" id="Jno" value="<s:property value='cnbean.Jno'/>"></td>
                  </tr>
                    <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>公司：</td>
                    <td><input name="Firm" type="text" class="text2" id="Firm" value="<s:property value='cnbean.Firm'/>"></td>
                  </tr>
                    <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>职位：</td>
                    <td><input name="Position" type="text" class="text2" id="Position" value="<s:property value='cnbean.Position'/>"></td>
                  </tr>
                   <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>行业：</td>
                    <td><input name="Industry" type="text" class="text2" id="Industry" value="<s:property value='cnbean.Industry'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>工作职责：</td>
                    <td><textarea rows="3" cols="25" name="Responsibility" id="Responsibility"><s:property value='cnbean.Responsibility'/></textarea></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <input type="hidden" name="Snoemployerold" value="<s:property value='cnbean.Snoemployer'/>"/>
                    <td>
                    <%if(!session.getAttribute("type").toString().equals("3")){%>
                    <input type="submit" name="button" id="button" value="修改招聘者">
                      &nbsp;&nbsp;
                      <%} else{%>
                     	<span style="color:blue"> 评价:<br/>
                      <s:iterator id="aa" value="aybean" >
                      	<span style="color:green"> ${InternRate}.</span><br/>
                      </s:iterator>
                      </span>
                      <%} %>
                      <br/>
